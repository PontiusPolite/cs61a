...
(define (derive-sum expr var)
  (+ (derive (first-operand expr) var) (derive (second-operand expr) var))
)

(define (derive-product expr var)
  (+ (* (derive (first-operand expr) var) (second-operand expr)) 
     (* (first-operand expr) (derive (second-operand expr) var))
  )
)
